...
{	
	...
	char input_file_name[] = "input2.bmp";
	char output_file_name_1[] = "output2_1.bmp";
	char output_file_name_2[] = "output2_2.bmp";
	...
	*/
	...
	input_bmp.convolution(filter1, output_bmp);
	output_bmp.xyz2rgb();
	...
	*	-1 -1 -1 -1 -1 -1 -1
	*/
	FILTER filter2(7, 0, 0);
	filter2.filter[ 0] = -0.1;
	filter2.filter[ 1] = -0.1;
	filter2.filter[ 2] = -0.1;
	filter2.filter[ 3] = -0.1;
	filter2.filter[ 4] = -0.1;
	filter2.filter[ 5] = -0.1;
	filter2.filter[ 6] = -0.1;
	filter2.filter[ 7] = -0.1;
	filter2.filter[ 8] = -0.2;
	filter2.filter[ 9] = -0.2;
	filter2.filter[10] = -0.2;
	filter2.filter[11] = -0.2;
	filter2.filter[12] = -0.2;
	filter2.filter[13] = -0.1;
	filter2.filter[14] = -0.1;
	filter2.filter[15] = -0.2;
	filter2.filter[16] =  0.1;
	filter2.filter[17] =  0.1;
	filter2.filter[18] =  0.1;
	filter2.filter[19] = -0.2;
	filter2.filter[20] = -0.1;
	filter2.filter[21] = -0.1;
	filter2.filter[22] = -0.2;
	filter2.filter[23] =  0.1;
	filter2.filter[24] =  5.8;
	filter2.filter[25] =  0.1;
	filter2.filter[26] = -0.2;
	filter2.filter[27] = -0.1;
	filter2.filter[28] = -0.1;
	filter2.filter[29] = -0.2;
	filter2.filter[30] =  0.1;
	filter2.filter[31] =  0.1;
	filter2.filter[32] =  0.1;
	filter2.filter[33] = -0.2;
	filter2.filter[34] = -0.1;
	filter2.filter[35] = -0.1;
	filter2.filter[36] = -0.2;
	filter2.filter[37] = -0.2;
	filter2.filter[38] = -0.2;
	filter2.filter[39] = -0.2;
	filter2.filter[40] = -0.2;
	filter2.filter[41] = -0.1;
	filter2.filter[42] = -0.1;
	filter2.filter[43] = -0.1;
	filter2.filter[44] = -0.1;
	filter2.filter[45] = -0.1;
	filter2.filter[46] = -0.1;
	filter2.filter[47] = -0.1;
	filter2.filter[48] = -0.1;
	input_bmp.convolution(filter2, output_bmp);
	output_bmp.xyz2rgb();
