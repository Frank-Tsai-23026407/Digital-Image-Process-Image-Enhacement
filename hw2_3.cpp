...
{	
	...
	char output_file_name_1[] = "output3_1.bmp";
	char output_file_name_2[] = "output3_2.bmp";
	...
	*	 1  4  7  4  1
	*/
	FILTER filter1(5, 0, 0);
	filter1.filter[ 0] =  1 / 273.0;
	filter1.filter[ 1] =  4 / 273.0;
	filter1.filter[ 2] =  7 / 273.0;
	filter1.filter[ 3] =  4 / 273.0;
	filter1.filter[ 4] =  1 / 273.0;
	filter1.filter[ 5] =  4 / 273.0;
	filter1.filter[ 6] = 16 / 273.0;
	filter1.filter[ 7] = 26 / 273.0;
	filter1.filter[ 8] = 16 / 273.0;
	filter1.filter[ 9] =  4 / 273.0;
	filter1.filter[10] =  7 / 273.0;
	filter1.filter[11] = 26 / 273.0;
	filter1.filter[12] = 41 / 273.0;
	filter1.filter[13] = 26 / 273.0;
	filter1.filter[14] =  7 / 273.0;
	filter1.filter[15] =  4 / 273.0;
	filter1.filter[16] = 16 / 273.0;
	filter1.filter[17] = 26 / 273.0;
	filter1.filter[18] = 16 / 273.0;
	filter1.filter[19] =  4 / 273.0;
	filter1.filter[20] =  1 / 273.0;
	filter1.filter[21] =  4 / 273.0;
	filter1.filter[22] =  7 / 273.0;
	filter1.filter[23] =  4 / 273.0;
	filter1.filter[24] =  1 / 273.0;
...
//	// median filter
//	input_bmp.medianfilter(5, output_bmp);
//	output_bmp.xyz2rgb();
//	output_bmp.createfile(output_file_name_2);
//	output_bmp.~BMP_FILE();
	
	// median filter with convolution
	input_bmp.medianfilter_convolution(5, filter1, output_bmp);
	output_bmp.xyz2rgb();
	output_bmp.createfile(output_file_name_2);
	output_bmp.~BMP_FILE();
